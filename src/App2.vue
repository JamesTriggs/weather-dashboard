...
export default {
  ...
  methods: {
    // TODO move these methods to a utility .js file and import
    // Utility Methods
    ...
    fahToCel: function(tempInFahrenheit) {
      var computedTempInFahrenheit = tempInFahrenheit - 32;
      var tempInCelcius = Math.round((5 / 9) * (computedTempInFahrenheit));
